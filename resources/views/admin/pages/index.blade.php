...
@endphp
<style>
    .pages-screen { min-height:100vh; padding:56px 30px 36px 38px; background:#eef1f7; color:#001a3d; }
    .pages-heading h1 { margin:0; font-size:2.75rem; line-height:1.1; font-weight:700; letter-spacing:0; color:#001438; }
    .pages-heading p { margin:10px 0 35px; font-size:1.48rem; color:#667789; }
    ...
    .pages-card-title { margin:0; font-size:1.55rem; font-weight:700; color:#001438; }
    ...
    .pages-select { width:152px; height:47px; border:1px solid #cdd6e2; border-radius:6px; padding:0 14px; font-size:1rem; color:#2d3748; background:#fff; }
    ...
    .pages-table td { padding:18px; font-size:1.42rem; vertical-align:middle; border-bottom:24px solid #fff; background:#f0f0f0; }
