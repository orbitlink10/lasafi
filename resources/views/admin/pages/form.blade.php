...
@section('content')
<style>
    .page-form-screen { min-height:100vh; padding:62px 28px 36px 22px; background:#eef1f7; color:#001438; }
    .page-form-wrap { max-width:1225px; }
    .page-form-title { margin:0 0 30px; font-size:2.7rem; line-height:1.1; font-weight:750; color:#001438; }
    ...
    .page-input, .page-select, .page-textarea { width:100%; border:1px solid #d9e1eb; border-radius:18px; color:#243246; background:#fff; font-size:1.42rem; outline:none; }
    ...
    .page-input::placeholder, .page-textarea::placeholder { color:#8794a3; }
    ...
    .tox.tox-tinymce { border-radius:14px; border-color:#e5e7eb; min-height:430px; }
