...
<div class="d-flex justify-content-between align-items-center mb-4"><h1 class="h3">Admin Dashboard</h1><div class="d-flex gap-2"><a class="btn btn-outline-primary" href="{{ route('admin.services.index') }}">Services</a><a class="btn btn-outline-primary" href="{{ route('admin.providers.index') }}">Providers</a><a class="btn btn-brand" href="{{ route('admin.reports.index') }}">Reports</a></div></div>
